...
prinCP=[]
try:
    prox= requests.get('https://github.com/K8B6/Approved/blob/main/Approve.txt').text
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46m KABBO
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46m SATTOJIT CHAKRABORTY KABBO 
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/K8B6/Approved/blob/main/Approve.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
#os.system('espeak -a 300 " Welcome,   to,  Kabbo,  V I P,  Tools"')
def back():
	login()
